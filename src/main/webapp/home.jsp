        ...
        <div class="row h-100 justify-content-between align-items-center">
            <div class="col-lg-12">
                <div class="text-center">
                    ...
                    <a href="all-products"><button class="btn btn-outline-warning" type="submit">view products</button></a>
                    <a href="add-Product"><button class="btn btn-outline-warning" type="submit">Add products</button></a>
                    <a href="buyProduct"><button class="btn btn-outline-warning" type="submit">Buy products</button></a>
